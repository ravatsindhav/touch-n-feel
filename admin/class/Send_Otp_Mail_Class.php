...
class Send_Otp_Mail_Class
{
    ...
    function send_otp($email, $otp)
    {
            ...
            <tbody>
              <tr style="vertical-align: top">
                <td style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
                                        ...
                                        <tr>
                                          <td style="padding-right: 0px; padding-left: 0px;" align="center">
                                            ...
                                            <div class="ribbon-wrapper">
                                              <h3 class="ribbon">
                                                <strong class="ribbon-inner">OTP for Reset Password</strong>
                                              </h3>
                                            </div>
                  ...
                  <hr style="border-top: 2px dashed #003399; width: 600px;">
                  <div class="u-row-container" style="padding: 0px;background-color: transparent">
                    <div class="u-row"
                      style="margin: 0 auto;min-width: 320px;max-width: 600px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: #ffffff;">
                      <div style="border-collapse: collapse;display: table;width: 100%;background-color: transparent;">
                            ...
                            <div
                                  ...
                                  <tr>
                                    <td
                                      ...
                                      <div style="line-height: 160%;">
                                        <p style="font-size: 14px; line-height: 160%; text-align: center;margin-bottom:20px;">
                                          <span style="font-size: 19px; line-height: 25px;">OTP for Your Email Address
                                          </span>
                                          <span
                                            style="font-size: 19px; line-height: 25px; font-weight: bold; margin-left:10px; color: #303f9f;">'.$email.'</span>
                                            <span style="font-size: 19px; line-height: 25px;">to Reset Your Password:
                                            </span>
                                        </p>
                                      
                                        <p
                                          style="font-size: 14px; text-align: center; padding: 10px; background: #e8eaf6; border: 2px dashed #003399; border-radius: 10px; width: 120px; margin: 0 auto;">
                                          <span style="font-size: 25px; color: #003399;margin-top: -10px;">'.$otp.'</span>
                                        </p>
                                        <p
                                        style="font-size: 14px; line-height: 160%; padding-top: 10px; text-align: center; margin-bottom: 10px;">
                                        <span style="font-size: 18px; line-height: 28.8px;">Do Not Share <b>OTP</b> With
                                          Anyone..</span>
                                      </p>
                                      </div>
                              ...
                              <table style="font-family:Cabin,sans-serif;" role="presentation" cellpadding="0" cellspacing="0"
                                ...
                                <tbody>
                                  <tr>
                                    <td
                                      style="overflow-wrap:break-word;word-break:break-word; padding:10px 55px 20px;font-family:Cabin,sans-serif;"
                                      align="left">
                                      ...
                                      <div style="line-height: 160%; text-align: center; word-wrap: break-word;">
                                        ...
                                        <p style="line-height: 160%; font-size: 14px;"><span
                                            style="font-size: 14px; line-height: 28.8px;">Please Do Not Reply </span></p>
                                      </div>
                                    ...
                                    <td
                                      ...
                                      <div
                                        ...
                                        <p style="font-size: 14px; line-height: 160%;"><span
                                            ...
                                            <a href="mailto: info@touchandfeelelectro.com" style="text-decoration: none;">info@touchandfeelelectro.com</a>
                                          </span>
                                        </p>
                                      </div>
        ...
        // Headers
        $headers = $this->common_header . $this->From;

        $mail_res = mail($to, $this->subject, $message, $headers);
        return $mail_res;
    }
}
?>
