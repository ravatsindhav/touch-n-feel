<head>
    ...
    <title>Reset Password| Complete Security Solution</title>
...
<body>
    ...
    <div class="row justify-content-center">
        <div class="card card-size border-0 card-top">
            <div class="one mt-5 mb-4">
                ...
                <p class="text-center mt-3 font-1" style="color: #303f9f;">Please enter your Email to Reset password !</p>
            </div>

            <form action="" method="post" role="form" class="form-spacing">
                <div class="form-group spacing">
                    <input type="email" name="email" class="form-control input-active mr-5" id="name" placeholder="Enter Your Email..." required>
                ...
                <div class="row justify-content-center">
                    <button type="submit" name="btn_submit" class="btn btn-default mx-auto w-50 btn-login">Send Email</button>
                </div>
            </form>
    ...
    if (isset($_POST['btn_submit'])) {
        ...
        require_once "class/Send_Otp_Mail_Class.php";
